        ...
        >
          {navLinks.map((link) => (
            <Link
              ...
              className="block px-4 py-3 rounded-xl text-foreground/80 hover:text-foreground hover:bg-black/5 transition-colors font-medium"
            >
              {link.label}
            </Link>
          ))}
            ...
            {session?.user ? (
              <div className="space-y-1">
                ...
                <Link
                  href="/profile"
                  onClick={handleLinkClick}
                  className="block px-4 py-3 rounded-xl text-foreground/80 hover:bg-black/5 transition-colors"
                >
